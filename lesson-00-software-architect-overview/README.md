# 🏛️ Lesson 00: Software Architect Overview
...
- ♻️ Understand the architect's involvement throughout the software development lifecycle
...
| # | Topic | Diagrams |
|---|-------|----------|
| 01 | [🎯 How a Software Architect Works](./01-how-a-software-architect-works/README.md) | 6 |
| 02 | [🏢 Organizational Positioning](./02-organizational-positioning/README.md) | 6 |
| 03 | [⚠️ Common Challenges](./03-common-challenges/README.md) | 1 |
| 04 | [📈 Success Metrics](./04-success-metrics/README.md) | 1 |

---

## 💪 Practical Exercises

1. **🗺️ Stakeholder Mapping**: Create a stakeholder map for a hypothetical project, identifying key stakeholders, their interests, and appropriate communication strategies.
...
5. **⚖️ Authority vs. Influence**: Describe a scenario where an architect needs to influence a decision they don't have direct authority over. What strategies would you use?
