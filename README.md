...
| 02 - Organizational Positioning | [README](./lesson-00-software-architect-overview/02-organizational-positioning/README.md) | [2.1 Org Structure Small](./lesson-00-software-architect-overview/02-organizational-positioning/2.1-org-structure-small.drawio) / [png](./lesson-00-software-architect-overview/02-organizational-positioning/2.1-org-structure-small.png)<br>[2.2 Org Structure Medium](./lesson-00-software-architect-overview/02-organizational-positioning/2.2-org-structure-medium.drawio) / [png](./lesson-00-software-architect-overview/02-organizational-positioning/2.2-org-structure-medium.png)<br>[2.3 Org Structure Large](./lesson-00-software-architect-overview/02-organizational-positioning/2.3-org-structure-large.drawio) / [png](./lesson-00-software-architect-overview/02-organizational-positioning/2.3-org-structure-large.png)<br>[2.4 Architect Role Hierarchy](./lesson-00-software-architect-overview/02-organizational-positioning/2.4-architect-role-hierarchy.drawio) / [png](./lesson-00-software-architect-overview/02-organizational-positioning/2.4-architect-role-hierarchy.png)<br>[2.5 Relationship Map](./lesson-00-software-architect-overview/02-organizational-positioning/2.5-relationship-map.drawio) / [png](./lesson-00-software-architect-overview/02-organizational-positioning/2.5-relationship-map.png)<br>[2.6 Authority vs Influence](./lesson-00-software-architect-overview/02-organizational-positioning/2.6-authority-vs-influence.drawio) / [png](./lesson-00-software-architect-overview/02-organizational-positioning/2.6-authority-vs-influence.png) |
| 03 - Common Challenges | [README](./lesson-00-software-architect-overview/03-common-challenges/README.md) | [3.1 Challenges Antipatterns](./lesson-00-software-architect-overview/03-common-challenges/3.1-challenges-antipatterns.drawio) / [png](./lesson-00-software-architect-overview/03-common-challenges/3.1-challenges-antipatterns.png) |
...
| 02 - Architecture Styles | [README](./lesson-01-software-design-architecture/02-architecture-styles/README.md) | [2.1 Monolithic Architecture](./lesson-01-software-design-architecture/02-architecture-styles/2.1-monolithic-architecture.drawio) / [png](./lesson-01-software-design-architecture/02-architecture-styles/2.1-monolithic-architecture.png)<br>[2.2 Microservices Architecture](./lesson-01-software-design-architecture/02-architecture-styles/2.2-microservices-architecture.drawio) / [png](./lesson-01-software-design-architecture/02-architecture-styles/2.2-microservices-architecture.png)<br>[2.3 SOA ESB Architecture](./lesson-01-software-design-architecture/02-architecture-styles/2.3-soa-esb-architecture.drawio) / [png](./lesson-01-software-design-architecture/02-architecture-styles/2.3-soa-esb-architecture.png)<br>[2.4 Serverless Architecture](./lesson-01-software-design-architecture/02-architecture-styles/2.4-serverless-architecture.drawio) / [png](./lesson-01-software-design-architecture/02-architecture-styles/2.4-serverless-architecture.png)<br>[2.5 Event Driven Architecture](./lesson-01-software-design-architecture/02-architecture-styles/2.5-event-driven-architecture.drawio) / [png](./lesson-01-software-design-architecture/02-architecture-styles/2.5-event-driven-architecture.png)<br>[2.6 Architecture Styles Comparison](./lesson-01-software-design-architecture/02-architecture-styles/2.6-architecture-styles-comparison.drawio) / [png](./lesson-01-software-design-architecture/02-architecture-styles/2.6-architecture-styles-comparison.png) |
| 03 - Architecture Principles | [README](./lesson-01-software-design-architecture/03-architecture-principles/README.md) | [3.1 SOLID Principles](./lesson-01-software-design-architecture/03-architecture-principles/3.1-solid-principles.drawio) / [png](./lesson-01-software-design-architecture/03-architecture-principles/3.1-solid-principles.png)<br>[3.2 Dependency Inversion](./lesson-01-software-design-architecture/03-architecture-principles/3.2-dependency-inversion.drawio) / [png](./lesson-01-software-design-architecture/03-architecture-principles/3.2-dependency-inversion.png) |
| 04 - API Design | [README](./lesson-01-software-design-architecture/04-api-design/README.md) | [4.1 REST API Flow](./lesson-01-software-design-architecture/04-api-design/4.1-rest-api-flow.drawio) / [png](./lesson-01-software-design-architecture/04-api-design/4.1-rest-api-flow.png)<br>[4.2 GraphQL Flow](./lesson-01-software-design-architecture/04-api-design/4.2-graphql-flow.drawio) / [png](./lesson-01-software-design-architecture/04-api-design/4.2-graphql-flow.png)<br>[4.3 gRPC Communication](./lesson-01-software-design-architecture/04-api-design/4.3-grpc-communication.drawio) / [png](./lesson-01-software-design-architecture/04-api-design/4.3-grpc-communication.png)<br>[4.4 WebSocket Flow](./lesson-01-software-design-architecture/04-api-design/4.4-websocket-flow.drawio) / [png](./lesson-01-software-design-architecture/04-api-design/4.4-websocket-flow.png)<br>[4.5 API Styles Comparison](./lesson-01-software-design-architecture/04-api-design/4.5-api-styles-comparison.drawio) / [png](./lesson-01-software-design-architecture/04-api-design/4.5-api-styles-comparison.png) |
...
| 02 - Message Brokers | [README](./lesson-02-event-driven-architecture/02-message-brokers/README.md) | [2.1 Kafka Architecture](./lesson-02-event-driven-architecture/02-message-brokers/2.1-kafka-architecture.drawio) / [png](./lesson-02-event-driven-architecture/02-message-brokers/2.1-kafka-architecture.png)<br>[2.2 RabbitMQ Architecture](./lesson-02-event-driven-architecture/02-message-brokers/2.2-rabbitmq-architecture.drawio) / [png](./lesson-02-event-driven-architecture/02-message-brokers/2.2-rabbitmq-architecture.png)<br>[2.3 Azure Service Bus](./lesson-02-event-driven-architecture/02-message-brokers/2.3-azure-service-bus.drawio) / [png](./lesson-02-event-driven-architecture/02-message-brokers/2.3-azure-service-bus.png)<br>[2.4 AWS SQS SNS](./lesson-02-event-driven-architecture/02-message-brokers/2.4-aws-sqs-sns.drawio) / [png](./lesson-02-event-driven-architecture/02-message-brokers/2.4-aws-sqs-sns.png)<br>[2.5 Message Brokers Comparison](./lesson-02-event-driven-architecture/02-message-brokers/2.5-message-brokers-comparison.drawio) / [png](./lesson-02-event-driven-architecture/02-message-brokers/2.5-message-brokers-comparison.png) |
| 03 - Event Patterns | [README](./lesson-02-event-driven-architecture/03-event-patterns/README.md) | [3.1 Event Sourcing](./lesson-02-event-driven-architecture/03-event-patterns/3.1-event-sourcing.drawio) / [png](./lesson-02-event-driven-architecture/03-event-patterns/3.1-event-sourcing.png)<br>[3.2 CQRS Pattern](./lesson-02-event-driven-architecture/03-event-patterns/3.2-cqrs-pattern.drawio) / [png](./lesson-02-event-driven-architecture/03-event-patterns/3.2-cqrs-pattern.png)<br>[3.3 Saga Choreography](./lesson-02-event-driven-architecture/03-event-patterns/3.3-saga-choreography.drawio) / [png](./lesson-02-event-driven-architecture/03-event-patterns/3.3-saga-choreography.png)<br>[3.4 Saga Orchestration](./lesson-02-event-driven-architecture/03-event-patterns/3.4-saga-orchestration.drawio) / [png](./lesson-02-event-driven-architecture/03-event-patterns/3.4-saga-orchestration.png)<br>[3.5 Compensating Transactions](./lesson-02-event-driven-architecture/03-event-patterns/3.5-compensating-transactions.drawio) / [png](./lesson-02-event-driven-architecture/03-event-patterns/3.5-compensating-transactions.png)<br>[3.6 Event Patterns Comparison](./lesson-02-event-driven-architecture/03-event-patterns/3.6-event-patterns-comparison.drawio) / [png](./lesson-02-event-driven-architecture/03-event-patterns/3.6-event-patterns-comparison.png) |
| 04 - Stream Processing | [README](./lesson-02-event-driven-architecture/04-stream-processing/README.md) | [4.1 Stream Processing Overview](./lesson-02-event-driven-architecture/04-stream-processing/4.1-stream-processing-overview.drawio) / [png](./lesson-02-event-driven-architecture/04-stream-processing/4.1-stream-processing-overview.png)<br>[4.2 Flink Kafka Streams](./lesson-02-event-driven-architecture/04-stream-processing/4.2-flink-kafka-streams.drawio) / [png](./lesson-02-event-driven-architecture/04-stream-processing/4.2-flink-kafka-streams.png)<br>[4.3 Stream Processing Comparison](./lesson-02-event-driven-architecture/04-stream-processing/4.3-stream-processing-comparison.drawio) / [png](./lesson-02-event-driven-architecture/04-stream-processing/4.3-stream-processing-comparison.png) |
| 05 - Async Communication Patterns | [README](./lesson-02-event-driven-architecture/05-async-communication-patterns/README.md) | [5.1 PubSub Pattern](./lesson-02-event-driven-architecture/05-async-communication-patterns/5.1-pubsub-pattern.drawio) / [png](./lesson-02-event-driven-architecture/05-async-communication-patterns/5.1-pubsub-pattern.png)<br>[5.2 Message Queue Pattern](./lesson-02-event-driven-architecture/05-async-communication-patterns/5.2-message-queue-pattern.drawio) / [png](./lesson-02-event-driven-architecture/05-async-communication-patterns/5.2-message-queue-pattern.png)<br>[5.3 Event Streams Pattern](./lesson-02-event-driven-architecture/05-async-communication-patterns/5.3-event-streams-pattern.drawio) / [png](./lesson-02-event-driven-architecture/05-async-communication-patterns/5.3-event-streams-pattern.png)<br>[5.4 Request Reply Pattern](./lesson-02-event-driven-architecture/05-async-communication-patterns/5.4-request-reply-pattern.drawio) / [png](./lesson-02-event-driven-architecture/05-async-communication-patterns/5.4-request-reply-pattern.png) |
...
| 02 - Microsoft Azure | [README](./lesson-03-cloud-platforms-services/02-microsoft-azure/README.md) | [2.1 Azure Compute Services](./lesson-03-cloud-platforms-services/02-microsoft-azure/2.1-azure-compute-services.drawio) / [png](./lesson-03-cloud-platforms-services/02-microsoft-azure/2.1-azure-compute-services.png)<br>[2.2 Azure Data Services](./lesson-03-cloud-platforms-services/02-microsoft-azure/2.2-azure-data-services.drawio) / [png](./lesson-03-cloud-platforms-services/02-microsoft-azure/2.2-azure-data-services.png)<br>[2.3 Azure Architecture Example](./lesson-03-cloud-platforms-services/02-microsoft-azure/2.3-azure-architecture-example.drawio) / [png](./lesson-03-cloud-platforms-services/02-microsoft-azure/2.3-azure-architecture-example.png) |
| 03 - Amazon Web Services | [README](./lesson-03-cloud-platforms-services/03-amazon-web-services/README.md) | [3.1 AWS Compute Services](./lesson-03-cloud-platforms-services/03-amazon-web-services/3.1-aws-compute-services.drawio) / [png](./lesson-03-cloud-platforms-services/03-amazon-web-services/3.1-aws-compute-services.png)<br>[3.2 AWS Data Services](./lesson-03-cloud-platforms-services/03-amazon-web-services/3.2-aws-data-services.drawio) / [png](./lesson-03-cloud-platforms-services/03-amazon-web-services/3.2-aws-data-services.png)<br>[3.3 AWS Architecture Example](./lesson-03-cloud-platforms-services/03-amazon-web-services/3.3-aws-architecture-example.drawio) / [png](./lesson-03-cloud-platforms-services/03-amazon-web-services/3.3-aws-architecture-example.png) |
| 04 - Google Cloud Platform | [README](./lesson-03-cloud-platforms-services/04-google-cloud-platform/README.md) | [4.1 GCP Compute Services](./lesson-03-cloud-platforms-services/04-google-cloud-platform/4.1-gcp-compute-services.drawio) / [png](./lesson-03-cloud-platforms-services/04-google-cloud-platform/4.1-gcp-compute-services.png)<br>[4.2 GCP Data Services](./lesson-03-cloud-platforms-services/04-google-cloud-platform/4.2-gcp-data-services.drawio) / [png](./lesson-03-cloud-platforms-services/04-google-cloud-platform/4.2-gcp-data-services.png) |
| 05 - Service Comparison | [README](./lesson-03-cloud-platforms-services/05-service-comparison/README.md) | [5.1 Compute Comparison](./lesson-03-cloud-platforms-services/05-service-comparison/5.1-compute-comparison.drawio) / [png](./lesson-03-cloud-platforms-services/05-service-comparison/5.1-compute-comparison.png)<br>[5.2 Database Comparison](./lesson-03-cloud-platforms-services/05-service-comparison/5.2-database-comparison.drawio) / [png](./lesson-03-cloud-platforms-services/05-service-comparison/5.2-database-comparison.png)<br>[5.3 Storage Comparison](./lesson-03-cloud-platforms-services/05-service-comparison/5.3-storage-comparison.drawio) / [png](./lesson-03-cloud-platforms-services/05-service-comparison/5.3-storage-comparison.png) |
| 06 - Cloud Native Design Principles | [README](./lesson-03-cloud-platforms-services/06-cloud-native-design-principles/README.md) | [6.1 Twelve Factor App](./lesson-03-cloud-platforms-services/06-cloud-native-design-principles/6.1-twelve-factor-app.drawio) / [png](./lesson-03-cloud-platforms-services/06-cloud-native-design-principles/6.1-twelve-factor-app.png)<br>[6.2 Cloud Native Patterns](./lesson-03-cloud-platforms-services/06-cloud-native-design-principles/6.2-cloud-native-patterns.drawio) / [png](./lesson-03-cloud-platforms-services/06-cloud-native-design-principles/6.2-cloud-native-patterns.png) |
| 07 - Multi-Cloud Hybrid Strategies | [README](./lesson-03-cloud-platforms-services/07-multi-cloud-hybrid-strategies/README.md) | [7.1 Multi-Cloud Architecture](./lesson-03-cloud-platforms-services/07-multi-cloud-hybrid-strategies/7.1-multi-cloud-architecture.drawio) / [png](./lesson-03-cloud-platforms-services/07-multi-cloud-hybrid-strategies/7.1-multi-cloud-architecture.png)<br>[7.2 Hybrid Cloud Patterns](./lesson-03-cloud-platforms-services/07-multi-cloud-hybrid-strategies/7.2-hybrid-cloud-patterns.drawio) / [png](./lesson-03-cloud-platforms-services/07-multi-cloud-hybrid-strategies/7.2-hybrid-cloud-patterns.png) |
...
| 02 - Authentication Protocols | [README](./lesson-04-identity-access-management/02-authentication-protocols/README.md) | [2.1 OAuth2 Flows](./lesson-04-identity-access-management/02-authentication-protocols/2.1-oauth2-flows.drawio) / [png](./lesson-04-identity-access-management/02-authentication-protocols/2.1-oauth2-flows.png)<br>[2.2 OIDC and SAML](./lesson-04-identity-access-management/02-authentication-protocols/2.2-oidc-and-saml.drawio) / [png](./lesson-04-identity-access-management/02-authentication-protocols/2.2-oidc-and-saml.png) |
| 03 - Microsoft Entra ID | [README](./lesson-04-identity-access-management/03-microsoft-entra-id/README.md) | [3.1 Entra ID Overview](./lesson-04-identity-access-management/03-microsoft-entra-id/3.1-entra-id-overview.drawio) / [png](./lesson-04-identity-access-management/03-microsoft-entra-id/3.1-entra-id-overview.png)<br>[3.2 App Registration Managed Identity](./lesson-04-identity-access-management/03-microsoft-entra-id/3.2-app-registration-managed-identity.drawio) / [png](./lesson-04-identity-access-management/03-microsoft-entra-id/3.2-app-registration-managed-identity.png)<br>[3.3 Conditional Access](./lesson-04-identity-access-management/03-microsoft-entra-id/3.3-conditional-access.drawio) / [png](./lesson-04-identity-access-management/03-microsoft-entra-id/3.3-conditional-access.png) |
| 04 - Access Control Models | [README](./lesson-04-identity-access-management/04-access-control-models/README.md) | [4.1 RBAC ABAC Models](./lesson-04-identity-access-management/04-access-control-models/4.1-rbac-abac-models.drawio) / [png](./lesson-04-identity-access-management/04-access-control-models/4.1-rbac-abac-models.png) |
| 05 - Zero Trust Architecture | [README](./lesson-04-identity-access-management/05-zero-trust-architecture/README.md) | [5.1 Zero Trust Architecture](./lesson-04-identity-access-management/05-zero-trust-architecture/5.1-zero-trust-architecture.drawio) / [png](./lesson-04-identity-access-management/05-zero-trust-architecture/5.1-zero-trust-architecture.png) |
| 06 - B2B B2C Scenarios | [README](./lesson-04-identity-access-management/06-b2b-b2c-scenarios/README.md) | [6.1 B2B B2C Scenarios](./lesson-04-identity-access-management/06-b2b-b2c-scenarios/6.1-b2b-b2c-scenarios.drawio) / [png](./lesson-04-identity-access-management/06-b2b-b2c-scenarios/6.1-b2b-b2c-scenarios.png) |
...
| 02 - CI/CD Tools | [README](./lesson-05-devops-platform-engineering/02-cicd-tools/README.md) | [2.1 Azure DevOps Architecture](./lesson-05-devops-platform-engineering/02-cicd-tools/2.1-azure-devops-architecture.drawio) / [png](./lesson-05-devops-platform-engineering/02-cicd-tools/2.1-azure-devops-architecture.png)<br>[2.2 GitHub Actions Workflow](./lesson-05-devops-platform-engineering/02-cicd-tools/2.2-github-actions-workflow.drawio) / [png](./lesson-05-devops-platform-engineering/02-cicd-tools/2.2-github-actions-workflow.png)<br>[2.3 CI/CD Tools Comparison](./lesson-05-devops-platform-engineering/02-cicd-tools/2.3-cicd-tools-comparison.drawio) / [png](./lesson-05-devops-platform-engineering/02-cicd-tools/2.3-cicd-tools-comparison.png)<br>[2.4 Jenkins Architecture](./lesson-05-devops-platform-engineering/02-cicd-tools/2.4-jenkins-architecture.drawio) / [png](./lesson-05-devops-platform-engineering/02-cicd-tools/2.4-jenkins-architecture.png) |
| 03 - Infrastructure as Code | [README](./lesson-05-devops-platform-engineering/03-infrastructure-as-code/README.md) | [3.1 Terraform Workflow](./lesson-05-devops-platform-engineering/03-infrastructure-as-code/3.1-terraform-workflow.drawio) / [png](./lesson-05-devops-platform-engineering/03-infrastructure-as-code/3.1-terraform-workflow.png)<br>[3.2 IaC Tools Comparison](./lesson-05-devops-platform-engineering/03-infrastructure-as-code/3.2-iac-tools-comparison.drawio) / [png](./lesson-05-devops-platform-engineering/03-infrastructure-as-code/3.2-iac-tools-comparison.png) |
| 04 - Containerization | [README](./lesson-05-devops-platform-engineering/04-containerization/README.md) | [4.1 Docker Architecture](./lesson-05-devops-platform-engineering/04-containerization/4.1-docker-architecture.drawio) / [png](./lesson-05-devops-platform-engineering/04-containerization/4.1-docker-architecture.png)<br>[4.2 Container Security Layers](./lesson-05-devops-platform-engineering/04-containerization/4.2-container-security-layers.drawio) / [png](./lesson-05-devops-platform-engineering/04-containerization/4.2-container-security-layers.png) |
| 05 - Container Orchestration | [README](./lesson-05-devops-platform-engineering/05-container-orchestration/README.md) | [5.1 Kubernetes Architecture](./lesson-05-devops-platform-engineering/05-container-orchestration/5.1-kubernetes-architecture.drawio) / [png](./lesson-05-devops-platform-engineering/05-container-orchestration/5.1-kubernetes-architecture.png)<br>[5.2 Kubernetes Resources](./lesson-05-devops-platform-engineering/05-container-orchestration/5.2-kubernetes-resources.drawio) / [png](./lesson-05-devops-platform-engineering/05-container-orchestration/5.2-kubernetes-resources.png)<br>[5.3 Managed K8s Comparison](./lesson-05-devops-platform-engineering/05-container-orchestration/5.3-managed-k8s-comparison.drawio) / [png](./lesson-05-devops-platform-engineering/05-container-orchestration/5.3-managed-k8s-comparison.png) |
| 06 - GitOps | [README](./lesson-05-devops-platform-engineering/06-gitops/README.md) | [6.1 GitOps Flow](./lesson-05-devops-platform-engineering/06-gitops/6.1-gitops-flow.drawio) / [png](./lesson-05-devops-platform-engineering/06-gitops/6.1-gitops-flow.png)<br>[6.2 ArgoCD Workflow](./lesson-05-devops-platform-engineering/06-gitops/6.2-argocd-workflow.drawio) / [png](./lesson-05-devops-platform-engineering/06-gitops/6.2-argocd-workflow.png) |
| 07 - Artifact Management | [README](./lesson-05-devops-platform-engineering/07-artifact-management/README.md) | [7.1 Artifact Management](./lesson-05-devops-platform-engineering/07-artifact-management/7.1-artifact-management.drawio) / [png](./lesson-05-devops-platform-engineering/07-artifact-management/7.1-artifact-management.png) |
...
| 02 - Secure Coding Practices | [README](./lesson-06-security/02-secure-coding-practices/README.md) | [2.1 Input Validation Strategy](./lesson-06-security/02-secure-coding-practices/2.1-input-validation-strategy.drawio) / [png](./lesson-06-security/02-secure-coding-practices/2.1-input-validation-strategy.png) |
| 03 - Secrets Management | [README](./lesson-06-security/03-secrets-management/README.md) | [3.1 Secrets Management](./lesson-06-security/03-secrets-management/3.1-secrets-management.drawio) / [png](./lesson-06-security/03-secrets-management/3.1-secrets-management.png) |
| 04 - Network Security | [README](./lesson-06-security/04-network-security/README.md) | [4.1 Defense in Depth](./lesson-06-security/04-network-security/4.1-defense-in-depth.drawio) / [png](./lesson-06-security/04-network-security/4.1-defense-in-depth.png)<br>[4.2 WAF Network Segmentation](./lesson-06-security/04-network-security/4.2-waf-network-segmentation.drawio) / [png](./lesson-06-security/04-network-security/4.2-waf-network-segmentation.png) |
| 05 - Security Testing | [README](./lesson-06-security/05-security-testing/README.md) | [5.1 Security Testing Types](./lesson-06-security/05-security-testing/5.1-security-testing-types.drawio) / [png](./lesson-06-security/05-security-testing/5.1-security-testing-types.png)<br>[5.2 Security Pipeline](./lesson-06-security/05-security-testing/5.2-security-pipeline.drawio) / [png](./lesson-06-security/05-security-testing/5.2-security-pipeline.png) |
...
| 02 - Cloud Networking | [README](./lesson-07-networking/02-cloud-networking/README.md) | [2.1 Virtual Network](./lesson-07-networking/02-cloud-networking/2.1-virtual-network.drawio) / [png](./lesson-07-networking/02-cloud-networking/2.1-virtual-network.png)<br>[2.2 Private Connectivity](./lesson-07-networking/02-cloud-networking/2.2-private-connectivity.drawio) / [png](./lesson-07-networking/02-cloud-networking/2.2-private-connectivity.png) |
| 03 - Load Balancing | [README](./lesson-07-networking/03-load-balancing/README.md) | [3.1 Load Balancing Types](./lesson-07-networking/03-load-balancing/3.1-load-balancing-types.drawio) / [png](./lesson-07-networking/03-load-balancing/3.1-load-balancing-types.png)<br>[3.2 Azure Load Balancing](./lesson-07-networking/03-load-balancing/3.2-azure-load-balancing.drawio) / [png](./lesson-07-networking/03-load-balancing/3.2-azure-load-balancing.png) |
| 04 - Service Mesh | [README](./lesson-07-networking/04-service-mesh/README.md) | [4.1 Service Mesh](./lesson-07-networking/04-service-mesh/4.1-service-mesh.drawio) / [png](./lesson-07-networking/04-service-mesh/4.1-service-mesh.png) |
...
| 02 - Relational Databases | [README](./lesson-08-databases-storage/02-relational-databases/README.md) | [2.1 Normalization Indexing](./lesson-08-databases-storage/02-relational-databases/2.1-normalization-indexing.drawio) / [png](./lesson-08-databases-storage/02-relational-databases/2.1-normalization-indexing.png) |
| 03 - NoSQL Databases | [README](./lesson-08-databases-storage/03-nosql-databases/README.md) | [3.1 NoSQL Patterns](./lesson-08-databases-storage/03-nosql-databases/3.1-nosql-patterns.drawio) / [png](./lesson-08-databases-storage/03-nosql-databases/3.1-nosql-patterns.png) |
| 04 - CAP Theorem Consistency | [README](./lesson-08-databases-storage/04-cap-theorem-consistency/README.md) | [4.1 CAP Theorem](./lesson-08-databases-storage/04-cap-theorem-consistency/4.1-cap-theorem.drawio) / [png](./lesson-08-databases-storage/04-cap-theorem-consistency/4.1-cap-theorem.png) |
| 05 - Caching | [README](./lesson-08-databases-storage/05-caching/README.md) | [5.1 Caching Strategies](./lesson-08-databases-storage/05-caching/5.1-caching-strategies.drawio) / [png](./lesson-08-databases-storage/05-caching/5.1-caching-strategies.png) |
| 06 - Storage Solutions | [README](./lesson-08-databases-storage/06-storage-solutions/README.md) | [6.1 Storage Types](./lesson-08-databases-storage/06-storage-solutions/6.1-storage-types.drawio) / [png](./lesson-08-databases-storage/06-storage-solutions/6.1-storage-types.png) |
...
| 02 - Logging | [README](./lesson-09-observability-monitoring/02-logging/README.md) | [2.1 Logging Stack](./lesson-09-observability-monitoring/02-logging/2.1-logging-stack.drawio) / [png](./lesson-09-observability-monitoring/02-logging/2.1-logging-stack.png) |
| 03 - Metrics | [README](./lesson-09-observability-monitoring/03-metrics/README.md) | [3.1 Metrics Types](./lesson-09-observability-monitoring/03-metrics/3.1-metrics-types.drawio) / [png](./lesson-09-observability-monitoring/03-metrics/3.1-metrics-types.png) |
| 04 - Distributed Tracing | [README](./lesson-09-observability-monitoring/04-distributed-tracing/README.md) | [4.1 Distributed Tracing](./lesson-09-observability-monitoring/04-distributed-tracing/4.1-distributed-tracing.drawio) / [png](./lesson-09-observability-monitoring/04-distributed-tracing/4.1-distributed-tracing.png) |
| 05 - Alerting | [README](./lesson-09-observability-monitoring/05-alerting/README.md) | [5.1 Alerting Strategy](./lesson-09-observability-monitoring/05-alerting/5.1-alerting-strategy.drawio) / [png](./lesson-09-observability-monitoring/05-alerting/5.1-alerting-strategy.png) |
...
| 02 - Leadership | [README](./lesson-10-soft-skills/02-leadership/README.md) | [2.1 Leadership Mentoring](./lesson-10-soft-skills/02-leadership/2.1-leadership-mentoring.drawio) / [png](./lesson-10-soft-skills/02-leadership/2.1-leadership-mentoring.png) |
| 03 - Business Acumen | [README](./lesson-10-soft-skills/03-business-acumen/README.md) | [3.1 Business Acumen](./lesson-10-soft-skills/03-business-acumen/3.1-business-acumen.drawio) / [png](./lesson-10-soft-skills/03-business-acumen/3.1-business-acumen.png) |
| 04 - Decision Making | [README](./lesson-10-soft-skills/04-decision-making/README.md) | [4.1 Decision Frameworks](./lesson-10-soft-skills/04-decision-making/4.1-decision-frameworks.drawio) / [png](./lesson-10-soft-skills/04-decision-making/4.1-decision-frameworks.png) |
| 05 - Problem Solving | [README](./lesson-10-soft-skills/05-problem-solving/README.md) | [5.1 Problem Solving](./lesson-10-soft-skills/05-problem-solving/5.1-problem-solving.drawio) / [png](./lesson-10-soft-skills/05-problem-solving/5.1-problem-solving.png) |
