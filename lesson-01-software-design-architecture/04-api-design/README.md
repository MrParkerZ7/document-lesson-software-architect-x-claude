...
> **Navigation**: [⬅️ Back to Lesson Overview](../README.md) | [Previous: Architecture Principles](../03-architecture-principles/README.md) | [Next: Data Architecture ➡️](../05-data-architecture/README.md)
...
| ✏️ PATCH | Partial update | ❌ No |
| 🗑️ DELETE | Remove resource | ✅ Yes |
...
PATCH  /api/users/123      # ✏️ Update user 123
DELETE /api/users/123      # 🗑️ Delete user 123
```
